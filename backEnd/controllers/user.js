        ...
        .then((hash) => {
            ...
            user
                ...
                .catch((error) => {
                    ...
                    res.status(400).json({
                        error,
                        message: "Problème d'enregistrement de l'utilisateur",
                    });
                });
        })
        .catch((error) => {
            ...
            res.status(500).json({
                error,
                message: "Problème à la création du compte utilisateur",
            });
        });
};
...
exports.login = (req, res, next) => {
    ...
    User.findOne({ email: req.body.email })
            ...
            if (user === null) {
                ...
                bcrypt
                    ...
                    .catch((error) => {
                        res.status(500).json({
                            error,
                            message: "L'authentification n'a pas pu aboutir",
                        });
                    });
            }
        })
        .catch((error) => {
            res
                .status(500)
                .json({ error, message: "L'authentification n'a pas pu aboutir" });
        });
};
